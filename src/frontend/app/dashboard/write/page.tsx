    ...
    return(
        <div className="h-full w-full flex flex-col xl:flex-row gap-2.5">
            <div className="flex flex-col w-full">
                <p>Remetente:</p>
                <input placeholder="Quem é o remetente?" type="text" className="bg-[#5c5e65] h-[35px] border rounded-3xl pl-5 focus:outline-none"/>
                <div className="h-2.5"/>
                <p>Assunto:</p>
                <input placeholder="Qual é o assunto?" type="text" className="bg-[#5c5e65] h-[35px] border rounded-3xl pl-5 focus:outline-none"/>
                <div className="h-2.5"/>
                <p>Email:</p>
                <textarea placeholder="Digite o email..." name="" id="" className="bg-[#5c5e65] h-[100px] min-[380px]:h-[150px] min-[420px]:h-[190px] md:h-60 xl:h-[300px] 2xl:h-[475px] border rounded-3xl px-5 py-2 focus:outline-none resize-none"></textarea>
            </div>
            {send ? (
            <>
                {result ? (
